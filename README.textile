...
bc. taps server postgres://buckybox:[production_db_password]@localhost/buckybox_production user [random_password]

bc. taps pull postgres://buckybox:[staging_db_password]@localhost/buckybox_staging http://user:[random_password]@my.buckybox.com:5000
