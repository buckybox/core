...
SELECT customers.id, customers.first_name, next_occurrence('2012-09-21', schedule_rules.*)
FROM "customers" 
INNER JOIN "accounts" ON "accounts"."customer_id" = "customers"."id" 
INNER JOIN "orders" ON "orders"."account_id" = "accounts"."id" AND "orders"."active" = 't'
