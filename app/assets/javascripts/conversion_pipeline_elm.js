...
Elm.ConversionPipeline.make = function (_elm) {
   ...
   var timestampToISODate = function (timestamp) {
      return function () {
         ...
         "",
         _L.fromArray([$Basics.toString($Date.year(date))
                      ,"-"
   ...
   var UpdateSegment = function (a) {
      return {ctor: "UpdateSegment"
             ,_0: a};
   };
   var UpdatePeriod = function (a) {
      return {ctor: "UpdatePeriod"
             ,_0: a};
   };
   var periodSelect = function (address) {
      ...
      _L.fromArray([A2($Html.label,
                   _L.fromArray([$Html$Attributes.$for("period")]),
                   _L.fromArray([$Html.text("period")]))
                   ,A2($Html.select,
                   _L.fromArray([$Html$Attributes.id("period")
                                ,A3($Html$Events.on,
                                "change",
                                $Html$Events.targetValue,
                                function ($) {
                                   return $Signal.message(address)(UpdatePeriod($));
                                })]),
                   A3($List.map2,
                   F2(function (i,s) {
                      return A2($Html.option,
                      _L.fromArray([$Html$Attributes.value(i)
   ...
   model) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("wrapper")]),
      _L.fromArray([A2($Html.div,
                   _L.fromArray([$Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                                      ,_0: "background"
                                                                      ,_1: "#ddd"}]))]),
                   _L.fromArray([$Html.text("Conversion Pipeline")]))
                   ,A2($Html.div,
                   _L.fromArray([]),
                   _L.fromArray([periodSelect(address)]))
                   ,A2($Html.div,
                   _L.fromArray([]),
                   _L.fromArray([$Html.fromElement(A2($ConversionPipeline$Graph.graph,
                   model.period,
                   model.segments))]))]));
   });
   var NoOp = {ctor: "NoOp"};
         ...
         function (_v0) {
            return function () {
               ...
               {case "_Tuple2": return {_: {}
                                       ,count: $Basics.toFloat(_v0._1)
                                       ,label: _v0._0};}
               _U.badCase($moduleName,
               "on line 172, column 19 to 53");
            }();
         },
         $List.reverse(result));
   ...
   model) {
      return function () {
         ...
         {case "NoOp": return model;
            case "UpdatePeriod":
            return _U.replace([["period"
                               ,action._0]],
              model);
            case "UpdateSegment":
            return _U.eq($List.length(model.segments),
              segmentCount) ? _U.replace([["segments"
                                          ,_L.fromArray([action._0])]],
              model) : _U.replace([["segments"
                                   ,A2($List.append,
                                   model.segments,
                                   _L.fromArray([action._0]))]],
              model);}
   ...
   var makeHttpResquest = function (action) {
      return function () {
         ...
         var period = $Maybe.withDefault(0)($Result.toMaybe($String.toFloat($Maybe.withDefault(initialModel.period)($List.head($List.drop(1)($String.split("\"")($Basics.toString(action))))))));
         var periodInMs = 365.25 / 12 * period * dayInMs;
         var timestamps = A2($List.map,
         function (index) {
            return loadTime - index * (periodInMs + dayInMs);
         },
         _L.range(0,segmentCount - 1));
         return $Task.sequence(A2($List.map,
         function (timestamp) {
            return function () {
               var from = timestampToISODate(timestamp - periodInMs);
               var to = timestampToISODate(timestamp);
   ...
   function () {
      ...
      return $Signal.map(makeHttpResquest)(A2($Signal.filter,
      needsFocus,
      NoOp)(actions.signal));
   }());
   ...
   _elm.ConversionPipeline.values = {_op: _op
                                    ,Model: Model
                                    ...
                                    ,actions: actions
                                    ,buildUrl: buildUrl
                                    ,timestampToISODate: timestampToISODate
...
Elm.ConversionPipeline.Common.make = function (_elm) {
   ...
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "ConversionPipeline.Common",
   $Basics = Elm.Basics.make(_elm),
   $Date = Elm.Date.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   _elm.ConversionPipeline.Common.values = {_op: _op
                                           ,State: State
                                           ,Segment: Segment};
   return _elm.ConversionPipeline.Common.values;
};
...
Elm.ConversionPipeline.Graph.make = function (_elm) {
   ...
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "ConversionPipeline.Graph",
   $Basics = Elm.Basics.make(_elm),
   ...
   var state_colors = _L.fromArray([A3($Color.rgb,
                                   145,
                                   191,
                                   144)
   ...
   var barScale = 10;
   var barTextRecord = F4(function (height,
   width,
   offset,
   hidden) {
      return function () {
         ...
         0) > 0 ? {_: {}
                  ,text: text
                  ,x: 0
                  ,y: barScale * offset + 20} : hidden ? {_: {}
                                                         ,text: ""
                                                         ,x: width / 2
                                                         ,y: barScale * offset + 20} : {_: {}
                                                                                       ,text: text
                                                                                       ,x: width / 2 + 20
                                                                                       ,y: barScale * offset};
      }();
   });
   var barRect = F3(function (bar,
   width,
   label) {
      return function () {
         var offset = bar.offset * barScale;
         var height = bar.height * barScale;
         var new_label = _U.eq(height,
         0) ? "" : label;
         ...
         return $Graphics$Collage.group(_L.fromArray([$Graphics$Collage.move({ctor: "_Tuple2"
                                                                             ,_0: 0
                                                                             ,_1: offset - height / 2})($Graphics$Collage.filled(bar.color)(A2($Graphics$Collage.rect,
                                                     width,
                                                     height)))
                                                     ,$Graphics$Collage.move({ctor: "_Tuple2"
                                                                             ,_0: 0
                                                                             ,_1: offset - height / 2})($Graphics$Collage.text($Text.fromString(new_label)))
                                                     ,$Graphics$Collage.move({ctor: "_Tuple2"
                                                                             ,_0: barText.x
                                                                             ,_1: barText.y})($Graphics$Collage.text($Text.fromString(barText.text)))]));
      }();
   });
   var gridLines = $List.concat(A2($List.map,
   function (y) {
      return function () {
         var width = 600;
         var color = _U.eq(y,
         ...
         return _L.fromArray([$Graphics$Collage.move({ctor: "_Tuple2"
                                                     ,_0: 0
                                                     ,_1: (0 - y) * barScale})($Graphics$Collage.filled(color)(A2($Graphics$Collage.rect,
                             width,
                             1)))
                             ,$Graphics$Collage.move({ctor: "_Tuple2"
                                                     ,_0: width / 2 + 20
                                                     ,_1: (0 - y) * barScale})($Graphics$Collage.text($Text.fromString($Basics.toString(y))))]);
      }();
   },
   A2($List.map,
   function (n) {
   ...
   var gridBars = function (all_bars) {
      return function () {
         var count = $List.length(all_bars);
         ...
         F2(function (bars,offset) {
            return $Graphics$Collage.moveX(0 - offset)($Graphics$Collage.group(A2($List.map,
            function (bar) {
               return A3(barRect,
               bar,
               barWidth,
   ...
   var collageWidth = 800 * 2;
   var collageHeight = 600 * 2;
   var relativeOriginY = collageHeight / 3;
   var legend = function (bars) {
      return $Graphics$Collage.move({ctor: "_Tuple2"
                                    ,_0: (0 - collageWidth) / 2 + barWidth * 2
                                    ,_1: relativeOriginY})($Graphics$Collage.group($List.concat(_L.fromArray([_L.fromArray([$Graphics$Collage.move({ctor: "_Tuple2"
                                                                                                                                                   ,_0: 0
                                                                                                                                                   ,_1: 150})($Graphics$Collage.text($Text.fromString("All time (not really)")))])
                                                                                                             ,legendBars(bars)]))));
   };
   var grid = F2(function (all_bars,
   period) {
      return $Graphics$Collage.move({ctor: "_Tuple2"
                                    ,_0: -200
                                    ,_1: relativeOriginY})($Graphics$Collage.group($List.concat(_L.fromArray([_L.fromArray([$Graphics$Collage.move({ctor: "_Tuple2"
                                                                                                                                                   ,_0: 0
                                                                                                                                                   ,_1: 150})($Graphics$Collage.text($Text.fromString(A2($Basics._op["++"],
                                                                                                             period,
                                                                                                             " month periods"))))])
                                                                                                             ,gridLines
                                                                                                             ,_L.fromArray([$Graphics$Collage.moveX(200)($Graphics$Collage.group(gridBars(all_bars)))])]))));
   });
   var Bar = F4(function (a,
   b,
   c,
   d) {
      return {_: {}
   ...
   var l = function (segment) {
      return function () {
         var createBar = F4(function (state,
         color,
         height,
         offset) {
            return A4(Bar,
         ...
         segment.states));
         var offsets = $List.concat(_L.fromArray([A2($List.take,
                                                 1,
                                                 counts)
                                                 ,A3($List.scanl,
                                                 F2(function (x,y) {
   ...
   var graph = F2(function (period,
   segments) {
      return function () {
         var all_bars = A2($List.map,
         l,
         segments);
         return A3($Graphics$Collage.collage,
         collageWidth,
         collageHeight,
         _L.fromArray([legend($Maybe.withDefault(_L.fromArray([]))($List.head(all_bars)))
                      ,A2(grid,all_bars,period)]));
      }();
   });
   _elm.ConversionPipeline.Graph.values = {_op: _op
                                          ,graph: graph};
   return _elm.ConversionPipeline.Graph.values;
};
Elm.Date = Elm.Date || {};
