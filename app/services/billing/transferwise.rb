  ...
  class Transferwise
    ...
    def self.overdue_invoices(distributor)
      ...
      unless @transactions[currency]
        today = Date.today
        url = "https://api.transferwise.com/v3/profiles/#{Figaro.env.transferwise_profile_id}/borderless-accounts/#{Figaro.env.transferwise_account_id}/statement.json?currency=#{currency}&intervalStart=2020-06-01T00:00:00.000Z&intervalEnd=#{today}T23:59:59.999Z"
