class Invoice < ActiveRecord::Base
  ...
  def starting_balance
    balance - transactions.inject(CrazyMoney.zero) { |sum, t| sum += t[:amount] }
  end
  ...
  def calculate_amount
    ...
    self.amount = deliveries.inject(CrazyMoney.zero) { |sum, occurrence| sum += occurrence[:amount] } - balance
