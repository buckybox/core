...
describe Admin::DistributorsController do
  ...
  # Distributor As you add validations to Admin::Distributor, be sure to
  # update the return value of this method accordingly.
  def valid_attributes
    {:email => 'test@enspiral.com', :password => 'password', :password_confirmation => 'password', :name => 'test'}
  end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "assigns the requested admin_distributor as @admin_distributor" do
        distributor = Distributor.create! valid_attributes
        put :update, {:id => distributor.to_param, :distributor => valid_attributes}
        assigns(:distributor).should eq(distributor)
      end
