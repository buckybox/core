...
describe "customer_addresses/new.html.haml" do
  before(:each) do
    assign(:address, stub_model(Customer::Address,
      :customer => nil,
      :address_1 => "MyString",
      :address_2 => "MyString",
      :suburb => "MyString",
  ...
  it "renders new address form" do
    ...
    assert_select "form", :action => customer_addresses_path, :method => "post" do
