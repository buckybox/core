...
describe "distributor_invoice_information/new.html.haml" do
  before(:each) do
    assign(:invoice_information, stub_model(Distributor::InvoiceInformation,
      :distributor => nil,
      :gst_number => "MyString",
  ...
  it "renders new invoice_information form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => distributor_invoice_information_index_path, :method => "post" do
